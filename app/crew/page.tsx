...
const Crew = () => {
  ...
  return (
    <>
      <div className=" grid gap-8 xl:h-[85vh] px-6 md:pt-10 justify-center text-center md:pb-0 xl:text-left xl:mx-auto">
        <div className="flex flex-col gap-4 md:flex-col-reverse max-w-[28.625rem] xl:grid xl:grid-cols-2 xl:rtl xl:max-w-[80vw]" style={{direction:"rtl"}}>
          ...
          <div className="flex flex-col-reverse pt-4 gap-4 xl:justify-items-start xl:self-center xl:gap-32" style={{direction:"ltr"}}>
            ...
            <div className="flex gap-2 md:gap-4 xl:gap-6 justify-center z-10" >
