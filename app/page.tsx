...
export default function Home() {
  ...
  return (
    <div className={`z-10 grid relative w-full min-h-screen Home__background bg-cover`}>
      <Header itemSelected={0}/>
      <div className=" pb-16 md:pb-20 px-6 text-center md:pt-[6.625rem] md:px-0 md:mx-auto xl:flex xl:items-end xl:m-0 xl:text-left xl:pb-[16vh] xl:max-w-full xl:h-fit xl:pt-64 xl:justify-around">
